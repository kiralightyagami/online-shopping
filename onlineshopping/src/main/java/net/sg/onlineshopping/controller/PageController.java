...
import net.sg.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
  ...
  public ModelAndView index()
  {
	  ...
	  logger.info("inside page controller index page-INFO");
	  logger.debug("Inside page controller index page-Debug");
  ...
  public ModelAndView showAllProducts()
  {
	  ...
	  //passing all lists of categories
  ...
  //Viewing a single product on single page
  ...
  @RequestMapping(value="/acces-denied")
  ...
  {
	  //first we are going to fetch the authetication
