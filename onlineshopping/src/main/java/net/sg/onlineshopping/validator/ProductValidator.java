package net.sg.onlineshopping.validator;
...
public class ProductValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		//check whether it is an image file or not
		...
		{
			errors.rejectValue("file", null, "Please select only an  image file to upload!");
			return ;
		}
