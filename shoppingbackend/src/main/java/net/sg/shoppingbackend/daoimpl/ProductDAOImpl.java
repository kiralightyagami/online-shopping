...
public class ProductDAOImpl implements ProductDAO	{
	...
	public List<Product> listActiveProductsByCategoryId(int categoryId) {
		String selectActiveProductsByCatgeory="FROM Product WHERE active= :active AND categoryId= :categoryId";
		return sessionFactory.getCurrentSession().createQuery(selectActiveProductsByCatgeory,Product.class).setParameter("active", true).setParameter("categoryId", categoryId).getResultList();
	}
